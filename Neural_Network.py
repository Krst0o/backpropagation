...
class Neural_Network(object):
    ...
    def __init__(self, eta=0.005, hidden_size=10):
        self.input_size = 2
    ...
    def backward(self, output):
        ...
        self.delta_2 = self.epsilon_2 * sigmoid_derivative(self.y2)

        self.epsilon_1 = self.delta_2.dot(self.W2.T)
        self.delta_1 = self.epsilon_1 * sigmoid_derivative(self.y1)
